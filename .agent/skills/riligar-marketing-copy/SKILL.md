...
- **Exemplos**: Veja [references/examples.md](references/examples.md) para modelos de headlines, subheadlines, body copy e CTAs.
- **Guia de Estilo**: Consulte [references/style-guide.md](references/style-guide.md) para diretrizes detalhadas sobre tom de voz, ritmo e palavras a evitar.
