...
const metrics = [
    {
        ...
        value: '24/7',
        label: 'Uptime',
        description: 'Agents work continuously without breaks, holidays, or sick days',
    },
    {
        icon: IconTrendingUp,
        value: '10-100x',
        label: 'Task Throughput',
        description: 'Handle exponentially more tasks than manual processes',
    },
    {
        icon: IconCoin,
        value: '60-80%',
        label: 'Cost Reduction',
        description: 'Lower operational costs compared to human-only teams',
    },
    {
        icon: IconUsers,
        value: '< 3 sec',
        label: 'Response Time',
        description: 'Near-instant responses to queries and requests',
    },
]
        ...
        >
            <Container size="xl">
                ...
                <Text
                    ...
                    mb={60}
                >
                    AI Agents deliver measurable ROI from day one. These aren't projections—these are real results from
                ...
                >
                    ...
                    <Text
                        ...
                        mb="md"
                    >
                        We're not an AI agency that learned to code. We're experienced software engineers (20+ years)
                        who now specialize in AI. That means:
                    </Text>
                    <Text
                        ta="center"
                        size="md"
